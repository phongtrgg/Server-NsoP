...
//                        }
    ...
    public static void sendMapInfo(@Nullable final User p, @NotNull Place self) throws IOException {
        ...
        //lang tone
        if (self.map.id == 22) {
            Service.sendEffectAuto(p, (byte) 13, 1428, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1428, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 336, 288, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 11, 185, 216, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 185, 216, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2284, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 2284, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1633, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1633, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 337, 288, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1872, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1872, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 12, 999, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 795, 216, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 795, 216, (byte) -1, (short) -1);
            }
            if (self.map.id == 1) {
            Service.sendEffectAuto(p, (byte) 13, 240, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 240, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 674, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 674, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 877, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 877, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 509, 288, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 509, 288, (byte) -1, (short) -1);
            }
            if (self.map.id == 2) {
            Service.sendEffectAuto(p, (byte) 13, 1206, 216, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1206, 216, (byte) -1, (short) -1);
            }
            if (self.map.id == 23) {
            Service.sendEffectAuto(p, (byte) 13, 548, 1848, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 548, 1848, (byte) -1, (short) -1);
            }
            if (self.map.id == 27) {
            Service.sendEffectAuto(p, (byte) 13, 489, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 489, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 673, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 673, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1026, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1026, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 12, 1663, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 9, 1663, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2064, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 9, 2064, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2587, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 2587, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 334, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 334, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 9, 334, 264, (byte) -1, (short) -1);
            }
            if (self.map.id == 72) {
            Service.sendEffectAuto(p, (byte) 13, 1427, 552, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1427, 552, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 755, 648, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 755, 648, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1553, 672, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 1553, 672, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 971, 672, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 971, 672, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 287, 672, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 0, 287, 672, (byte) -1, (short) -1);
            }
            if (self.map.id == 10) {
            Service.sendEffectAuto(p, (byte) 13, 313, 288, (byte) -1, (short) -1);
            }
            if (self.map.id == 32) {
            Service.sendEffectAuto(p, (byte) 13, 2356, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2406, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2456, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2509, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2552, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2582, 384, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2620, 384, (byte) -1, (short) -1);
            }
            if (self.map.id == 38) {
            Service.sendEffectAuto(p, (byte) 13, 549, 336, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 417, 336, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 256, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 212, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 170, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 124, 360, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 91, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 197, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 307, 264, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 335, 192, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 433, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 451, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 515, 240, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 563, 240, (byte) -1, (short) -1);
            }
            if (self.map.id == 139) {
            Service.sendEffectAuto(p, (byte) 12, 262, 384, (byte) -1, (short) -1);
            }
            if (self.map.id == 140) {
            Service.sendEffectAuto(p, (byte) 13, 185, 816, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 12, 947, 840, (byte) -1, (short) -1);
            }
            if (self.map.id == 17) {
            Service.sendEffectAuto(p, (byte) 13, 191, 264, (byte) -1, (short) -1);
            }
            if (self.map.id == 43) {
            Service.sendEffectAuto(p, (byte) 13, 695, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 757, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 800, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 850, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 900, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 950, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1000, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1050, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1100, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1150, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1200, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1250, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1300, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1350, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1400, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1450, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1500, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1550, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1600, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1650, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2173, 408, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2066, 456, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 1974, 432, (byte) -1, (short) -1);
            Service.sendEffectAuto(p, (byte) 13, 2235, 456, (byte) -1, (short) -1);
            }
            if (self.map.id == 48) {
            Service.sendEffectAuto(p, (byte) 13, 542, 264, (byte) -1, (short) -1);
            }
            if (self.map.id == 38) {
            Service.sendEffectAuto(p, (byte) 13, 491, 336, (byte) -1, (short) -1);
            return;
        }
    }
