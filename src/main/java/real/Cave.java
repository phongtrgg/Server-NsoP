...
public class Cave {
    ...
    private void initMap(final int x) {
        switch (x) {
            ...
            case 10 : {
                this.map[0] = new Map(167, this);
                this.map[1] = new Map(168, this);
                break;
            }
        }
    }
        ...
        synchronized (this) {
            ...
            if (this.x != 6 || this.finsh == 0) {
                ...
                for (byte i = 0; i < this.ninjas.size(); ++i) {
                    ...
                    nj.p.sendYellowMessage("Hành trình khám phá hang động đã kết thúc, hãy đến Katana đánh giá và nhận thưởng.");
